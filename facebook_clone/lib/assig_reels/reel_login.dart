...
class ReelLoginView extends StatelessWidget {
  ReelLoginView({super.key});
            ...
            Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                      color:
                          Color(0xFF75A035), //Color.fromARGB(50, 66, 103, 178),
                      //Colors.blue,
                      fontSize: 60,
                      fontWeight: FontWeight.bold),
                ),
                Text(
                  'This app show the reels of your choice.',
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: Color(0xFF75A035),
                        //Colors.blue,
                  ...
                  TextButton(
                    ...
                    style: ButtonStyle(
                      foregroundColor:
                          WidgetStateProperty.all(Color(0xFF75A035)),
                      textStyle:
...
//        MaterialPageRoute(builder: (context) => TabBarClass()),
        MaterialPageRoute(builder: (context) => ReelWelcomeview()),
      );
    } else {
      print('Login Failed');
    }
